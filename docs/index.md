...
<section class="hero" aria-labelledby="page-title">
  <div class="hero-copy">
    <p class="eyebrow">zeanrovin / personal/technical dump writing </p>
    <h1 id="page-title">Thoughtful notes<br>for the curious web.</h1>
    <p class="intro">
      I write about technology, learning, and the small details that make digital
      products feel better.
    </p>
    <a class="jump-link" href="#latest">Read the latest <span aria-hidden="true">↓</span></a>
  </div>

  <figure class="hero-image" aria-hidden="true">
    <img src="assets/images/hero.jpeg" alt="Portrait of Zean Rovin Balita">
  </figure>
</section>
...
<section class="latest" id="latest" aria-labelledby="latest-title">
  ...
  <a class="article-card" href="migration/intro/">
    <div class="article-meta">
      ...
      <span>6 MIN READ + 4 DEEP DIVES</span>
    </div>
